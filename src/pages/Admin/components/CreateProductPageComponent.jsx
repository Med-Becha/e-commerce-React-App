      ...
      <Row className="justify-content-md-center mt-5">
        ...
        <Col md={6}>
          ...
          <Form noValidate validated={validated} onSubmit={handleSubmit} onKeyDown={(e) => checkKeyDown(e)} >
            ...
            <Form.Group>
              <Button onClick={() =>setSelectBtnValue(!selectBtnValue)}>show in home Page ? {selectBtnValue ? <i className="bi  bi-check2"></i> :  <i className="bi text-center bi-x-circle"></i>}</Button>
            </Form.Group>
